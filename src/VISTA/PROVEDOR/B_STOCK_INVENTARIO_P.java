...
public class B_STOCK_INVENTARIO_P extends javax.swing.JFrame {
    
    int xMouse, yMouse;
    
    public B_STOCK_INVENTARIO_P() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        bg.add(btnstock, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 190, 40));
        ...
        bg.add(btnreporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 460, 190, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(B_STOCK_INVENTARIO_P.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new B_STOCK_INVENTARIO_P().setVisible(true);
            }
        });
    }
