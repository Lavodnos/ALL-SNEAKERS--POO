...
public class C_Reporte_Admin_P extends javax.swing.JFrame {
    
    int xMouse, yMouse;
    
    public C_Reporte_Admin_P() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_Reporte_Admin_P.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new C_Reporte_Admin_P().setVisible(true);
            }
        });
    }
