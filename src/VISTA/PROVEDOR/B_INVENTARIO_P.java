...
public class B_INVENTARIO_P extends javax.swing.JFrame {
    
    int xMouse, yMouse;
    
    public B_INVENTARIO_P() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnFILTRARNOMBRE1 = new javax.swing.JButton();
        ...
        LABELADMINSTRADOR1.setText("PROVEDOR");
        ...
        LABELADMINSTRADOR.setText("INVENTARIO");
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(headerLayout.createSequentialGroup()
                ...
                .addComponent(LABELADMINSTRADOR, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(527, 527, 527))
        );
        ...
        btnstock.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/REPORTE.png"))); // NOI18N
        ...
        header1.add(btnstock, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 190, 40));

        btnreporte.setBackground(new java.awt.Color(204, 204, 204));
        btnreporte.setFont(new java.awt.Font("Roboto Condensed Light", 1, 14)); // NOI18N
        btnreporte.setForeground(new java.awt.Color(0, 0, 0));
        btnreporte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/editar-product.png"))); // NOI18N
        btnreporte.setText("     REPORTES");
        btnreporte.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        header1.add(btnreporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 560, 190, 40));
        ...
        btnActualizar.setFont(new java.awt.Font("Roboto Condensed Light", 1, 14)); // NOI18N
        btnActualizar.setForeground(new java.awt.Color(0, 0, 0));
        btnActualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/menos.png"))); // NOI18N
        ...
        bg.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 60, 190, 40));
        ...
        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, 860, 720));

        btnFILTRARCodigo.setBackground(new java.awt.Color(204, 204, 204));
        btnFILTRARCodigo.setFont(new java.awt.Font("Roboto Condensed Light", 1, 14)); // NOI18N
        btnFILTRARCodigo.setForeground(new java.awt.Color(0, 0, 0));
        btnFILTRARCodigo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/editar-product.png"))); // NOI18N
        btnFILTRARCodigo.setText("FILTRAR POR CODIGO");
        btnFILTRARCodigo.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        btnFILTRARCodigo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnFILTRARCodigo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFILTRARCodigoActionPerformed(evt);
            }
        });
        bg.add(btnFILTRARCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 370, 210, 40));

        txtFcodigo.setFont(new java.awt.Font("Roboto Condensed Light", 1, 18)); // NOI18N
        bg.add(txtFcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 300, 270, 40));

        txtFName.setFont(new java.awt.Font("Roboto Condensed Light", 1, 18)); // NOI18N
        bg.add(txtFName, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 150, 270, 40));
        ...
        bg.add(btnGuardarIMG, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 480, 380, 250));
        bg.add(txtcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(1330, 460, 220, 20));

        btnFILTRARNOMBRE1.setBackground(new java.awt.Color(204, 204, 204));
        btnFILTRARNOMBRE1.setFont(new java.awt.Font("Roboto Condensed Light", 1, 14)); // NOI18N
        btnFILTRARNOMBRE1.setForeground(new java.awt.Color(0, 0, 0));
        btnFILTRARNOMBRE1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/editar-product.png"))); // NOI18N
        btnFILTRARNOMBRE1.setText("FILTRAR POR NOMBRE");
        btnFILTRARNOMBRE1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        btnFILTRARNOMBRE1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnFILTRARNOMBRE1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFILTRARNOMBRE1ActionPerformed(evt);
            }
        });
        bg.add(btnFILTRARNOMBRE1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 210, 210, 40));
    ...
    private void btnFILTRARNOMBRE1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFILTRARNOMBRE1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnFILTRARNOMBRE1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(B_INVENTARIO_P.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new B_INVENTARIO_P().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JButton btnFILTRARNOMBRE1;
    ...
    public javax.swing.JTextField txtFcodigo;
