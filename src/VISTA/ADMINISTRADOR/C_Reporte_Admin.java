...
public class C_Reporte_Admin extends javax.swing.JFrame {
    
    int xMouse, yMouse;
    
    public C_Reporte_Admin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnMOSTRARV.setBackground(new java.awt.Color(204, 204, 204));
        btnMOSTRARV.setFont(new java.awt.Font("Roboto Condensed Light", 1, 14)); // NOI18N
        btnMOSTRARV.setForeground(new java.awt.Color(0, 0, 0));
        btnMOSTRARV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/INVENTARIO.png"))); // NOI18N
        btnMOSTRARV.setText("    MOSTRAR");
        btnMOSTRARV.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        btnMOSTRARV.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnMOSTRARV.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnMOSTRARVMouseClicked(evt);
            }
        });
        bg.add(btnMOSTRARV, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 70, 190, 40));
        ...
        LABELADMINSTRADOR.setText("Reporte de Ventas");
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(headerLayout.createSequentialGroup()
                ...
                .addGap(471, 471, 471)
                .addComponent(LABELADMINSTRADOR, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jtableVentas.setFont(new java.awt.Font("Roboto Light", 1, 14)); // NOI18N
        jtableVentas.setForeground(new java.awt.Color(198, 0, 0));
        jtableVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Producto", "Nombre", "Categoria", "Stock", "Precio", "Fecha Entrada"
            }
        ) {
        ...
        jtableVentas.setSelectionBackground(new java.awt.Color(153, 0, 51));
        jtableVentas.setSelectionForeground(new java.awt.Color(255, 0, 51));
        jScrollPane3.setViewportView(jtableVentas);

        bg.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, 1170, 680));

        LABELADMINSTRADOR2.setBackground(new java.awt.Color(255, 255, 255));
        LABELADMINSTRADOR2.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        LABELADMINSTRADOR2.setForeground(new java.awt.Color(255, 255, 255));
        LABELADMINSTRADOR2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/LogoAll -PEQ.png"))); // NOI18N
        LABELADMINSTRADOR2.setText("LISTADO DE VENTAS ");
        bg.add(LABELADMINSTRADOR2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 80, 200, 30));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(bg, javax.swing.GroupLayout.DEFAULT_SIZE, 1532, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_Reporte_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new C_Reporte_Admin().setVisible(true);
            }
        });
    }
