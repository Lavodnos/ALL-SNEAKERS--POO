...
public class Producto_C_Admin extends javax.swing.JFrame {
    
    int xMouse, yMouse;
    
    public Producto_C_Admin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnCREARPRDUCTO1 = new javax.swing.JButton();
        ...
        LABELADMINSTRADOR.setText("CREAR PRODUCTOS");
        ...
        bg.add(btnGuardarIMG, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 540, 300, 230));
        ...
        bg.add(LABELADMINSTRADOR3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 230, 220, 60));

        txtNOMBREP.setFont(new java.awt.Font("Roboto Condensed Light", 1, 18)); // NOI18N
        bg.add(txtNOMBREP, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 140, 650, 40));

        cboCategoria.setFont(new java.awt.Font("Roboto Condensed Light", 1, 18)); // NOI18N
        cboCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECCIONAR", "CATEGORIA 1 ", "CATEGORIA 2" }));
        bg.add(cboCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 240, 650, -1));
        ...
        bg.add(LABELADMINSTRADOR6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130, 240, 60));
        ...
        LABELADMINSTRADOR5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/dinero.png"))); // NOI18N
        LABELADMINSTRADOR5.setText("       PRECIO : ");
        bg.add(LABELADMINSTRADOR5, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 340, 220, 50));
        ...
        bg.add(LABELADMINSTRADOR7, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 420, 220, 50));

        txtstock.setFont(new java.awt.Font("Roboto Condensed Light", 1, 18)); // NOI18N
        bg.add(txtstock, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 430, 650, 30));

        btnCREARPRDUCTO1.setBackground(new java.awt.Color(204, 204, 204));
        btnCREARPRDUCTO1.setFont(new java.awt.Font("Roboto Condensed Light", 1, 14)); // NOI18N
        btnCREARPRDUCTO1.setForeground(new java.awt.Color(0, 0, 0));
        btnCREARPRDUCTO1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/editar-product.png"))); // NOI18N
        btnCREARPRDUCTO1.setText("CREAR PRODUCTO");
        btnCREARPRDUCTO1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        btnCREARPRDUCTO1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnCREARPRDUCTO1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCREARPRDUCTO1ActionPerformed(evt);
            }
        });
        bg.add(btnCREARPRDUCTO1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 740, 190, 40));

        txtPrecio.setFont(new java.awt.Font("Roboto Condensed Light", 1, 18)); // NOI18N
        bg.add(txtPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 340, 650, 40));
    ...
    private void btnCREARPRDUCTO1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCREARPRDUCTO1ActionPerformed
        // TODO add your handling code here:
        
        
    }//GEN-LAST:event_btnCREARPRDUCTO1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Producto_C_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Producto_C_Admin().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JButton btnCREARPRDUCTO1;
